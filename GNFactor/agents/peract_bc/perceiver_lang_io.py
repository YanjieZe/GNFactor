...
from helpers.network_utils import DenseBlock, SpatialSoftmax3D, Conv3DBlock, Conv3DUpsampleBlock, print_params
...
class PerceiverVoxelLangEncoder(nn.Module):
    ...
    def forward(
        ...
        if SAVE_INTERNAL_TENSOR:
            ...
            import os
            os.makedirs('/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract', exist_ok=True)
            self.save_tensor(ins, f'/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract/input_voxel_{counter}.pkl')
            print("save input voxel tensor.")
            self.save_tensor(d0, f'/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract/deep_voxel_{counter}.pkl')
            print("save deep voxel tensor.")
            self.save_tensor(lang_token_embs, f'/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract/lang_token_embs_{counter}.pkl')
        ...
        if SAVE_INTERNAL_TENSOR:
            ...
            self.save_tensor(l, f'/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract/reduced_lang_token_{counter}.pkl')
        ...
        if SAVE_INTERNAL_TENSOR:
            self.save_tensor(u0, f'/home/yanjieze/projects/nerf-act/internal_feat_pkl_peract/upsampled_feat_voxel_{counter}.pkl')
