...
class GeneralizableNeRFEmbedNet(torch.nn.Module):
    def __init__(self, conf, stop_encoder_grad=False):
        ...
        super().__init__()
        self.conf = conf
        self.coordinate_bounds = conf.coordinate_bounds
        ...
        # Regress coordinates
        self.regress_coord = conf.regress_coord
        print(colored(f"[GeneralizableNeRFEmbedNet] regress_coord: {self.regress_coord}", "red"))

        # Regress attention
        self.regress_attention = conf.regress_attention
        ...
        self.use_multi_scale_voxel = conf.use_multi_scale_voxel
    ...
    def encode(self, voxel_feat, lang=None, multi_scale_voxel_list=None, voxel_density=None, poses=None, focal=None,  c=None):
        ...
        if not self.use_multi_scale_voxel:
    ...
    def sample_in_canonical_voxel(self, xyz):
        """
        :param xyz (B, 3)
        :return (B, Feat)
        """
